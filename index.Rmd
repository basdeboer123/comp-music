...
box_plot_king_queen <- ggplot(stack(corpus_combined_select), aes(x = values, y = ind, fill(~test))) +
  ...
  labs(title = "Comparison of Mean features between Michael Jackson and Madonna") +
  theme_bw()+
...
combined_violin %>%
  ...
  labs(title = "Average timbre coefficients for the Michael Jackson and Madonna playlists", x = "Spotify Timbre Coefficients", y = "", fill = "Artist")
...
king_queen_features %>%
  ggplot(aes(x = acousticness, y = danceability, colour = playlist, size = valance)) +
...
![bpm](/home/bas/compmusic/compmusic/index_files/figure-html/importance-1.png){width=33%}
![bpm](/home/bas/compmusic/compmusic/index_files/figure-html/importance-2.png){width=33%}
![bpm](/home/bas/compmusic/compmusic/index_files/figure-html/importance-3.png){width=33%}
